...
public class StorageMarketSellInTike : StorageResurs
{
	public StorageMarketSellInTike(ILoadResInStorag loadRes) : base(loadRes) { }
	...
	public void SetSellRes(TipeResurs typeRes, int coll)
	{
		if (IsHaveRes(typeRes))
		{
			CollAllResurs[typeRes] = coll;
		...
		throw new Exception("Ошибка в присвоении колличества ресурсо,причина не извесна, в" + this.GetType());
	}
}
